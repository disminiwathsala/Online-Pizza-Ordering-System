...
(1, 'Pizza World', 'Pizza World@gmail.com', +94-2515469442, +94-6304468851, '210 Colombo - Galle Main Rd, Colombo 00300', '2021-03-23 19:56:25');
...
ALTER TABLE `categories`  FULLTEXT KEY `categorieName` (`categorieName`,`categorieDesc`);
